...
hundreds = (
    ...
    u'п\'ятьсот ', u'шістсот',
    u'сімсот ', u'вісімсот',
    u'дев\'ятьсот '
)

orders = (  # plural forms and gender
    # ((U '', u '', u ''), 'm'), # ((u'рубль ', u'рубля', u'рублей '),' m '), # ((u' копійка ', u'копейкі', u'копеек '),' f ')
        ...
        try:
            ...
            if '.' in num:
                print(decimal2text(
                    ...
                    exp_units=((u'кусок', u'куска', u'кусків'), 'm')))
            else:
                print(num2text(
                    int(num),
